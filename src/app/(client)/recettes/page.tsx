            ...
            <div className="mt-10">
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {recipe.available_ingredients.map((item: any) => (
                    <div
                      key={item.id}
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-2">
                  {recipe.missing_ingredients.map((item: string, index: number) => (
                    <div
                      key={index}
                      className="inline-flex items-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-medium text-gray-900 ring-1 ring-inset ring-gray-300 bg-gray-50"
                    >
